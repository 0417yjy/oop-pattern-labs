...
public class SampleFormats {
	public static void main(String[] args) {
		...
		/* Tests */
		/*
		 * System.out.println("Date: " + dateFormat.format(new GregorianCalendar(2005,
		 * 7, 4).getTime())); // dateFormat.format() expects a Date object. Use //
		 * GregorianCalendar to construct a Calendar object and the // getTime() method
		 * // to convert it to a Date. System.out.println("Integer: " +
		 * intFormat.format(1234567)); System.out.println("Integer: " +
		 * intFormat.format(67.7)); System.out.println("Money: " +
		 * dollarFormat.format(9812345.678)); System.out.println("Money: " +
		 * dollarFormat.format(9812345)); System.out.println("Money: " +
		 * dollarFormat.format(.78)); System.out.println("Person: " +
		 * personFormat.format(new Object[] { "Weinman", "Jerod", "weinman" }));
		 */
